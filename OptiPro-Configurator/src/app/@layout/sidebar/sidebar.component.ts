...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    let temp_menu_data = [
      ...
      { "itemCode": "205", "itemName": this.language.need_assessment_rule, "itemNav": "/need-assessment-rule", "itemIcon": "#assessmentRule", "itemIconSize": "0 0 504.123 504.123", "permission": true },
