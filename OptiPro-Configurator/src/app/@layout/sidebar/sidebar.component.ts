...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    let temp_menu_data = [  
      ...
      { "itemCode": "205", "itemName": this.language.need_Customer_mapping, "itemNav": "/needAssesment-customer-mapping", "itemIcon": "#configure", "itemIconSize": "0 0 512 512", "permission":true}
    ];
