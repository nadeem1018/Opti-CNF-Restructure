...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    let temp_menu_data = [
      ...
      { "itemCode": "205", "itemName": this.language.attribute, "itemNav": "/attribute", "itemIcon": "#attributeMaster", "itemIconSize": "0 0 25 25", "permission": true },
      { "itemCode": "205", "itemName": this.language.need_assessment, "itemNav": "/need-assessment", "itemIcon": "#assessmentScreen", "itemIconSize": "0 0 25 25", "permission": true },
      { "itemCode": "205", "itemName": this.language.need_assessment_template, "itemNav": "/need-assessment-template", "itemIcon": "#assessmentTemplate", "itemIconSize": "0 0 25 25", "permission": true },
      { "itemCode": "205", "itemName": this.language.need_assessment_rule, "itemNav": "/need-assessment-rule", "itemIcon": "#assessmentRule", "itemIconSize": "0 0 25 25", "permission": true },
      { "itemCode": "205", "itemName": this.language.config_need_assesment, "itemNav": "/configuration-needAssesment", "itemIcon": "#configurationAssesment", "itemIconSize": "0 0 25 25", "permission": true },
      { "itemCode": "205", "itemName": this.language.need_Customer_mapping, "itemNav": "/needAssesment-customer-mapping", "itemIcon": "#assessmentTemplateMapping", "itemIconSize": "0 0 25 25", "permission": true }
    ];
