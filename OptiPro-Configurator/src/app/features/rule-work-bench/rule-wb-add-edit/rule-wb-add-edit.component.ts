...
@Component({
  selector: 'app-rule-wb-add-edit',
  templateUrl: './rule-wb-add-edit.component.html',
  styleUrls: ['./rule-wb-add-edit.component.scss']
})
export class RuleWbAddEditComponent implements OnInit {

  @ViewChild("rulecode", { static: true }) _el: ElementRef;
  @ViewChild("showOutputButton", { static: true }) _ele: ElementRef;
  public commonData = new CommonData();
  public view_route_link = '/rule-work-bench/view';
  ...
  constructor(private ActivatedRouter: ActivatedRoute, private route: Router, private service: RulewbService, private CommonService: CommonService, private DialogService: DialogService) { }
  ...
  show_operand_lookup(type, type_value, rowindex, operand_value) {
    if (type_value == "" || type_value == undefined || type_value == null) {
      this.CommonService.show_notification(this.language.invalidFeatureModel + " " + rowindex, 'warning');
      return false;
    }
    CommonData.made_changes = true;
    this.showLookupLoader = true;
