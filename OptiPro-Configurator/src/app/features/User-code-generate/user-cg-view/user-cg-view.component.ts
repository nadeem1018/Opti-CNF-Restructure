...
import { dealercodegemerateService } from 'src/app/core/service/dealercodegenerate.service';
import { Router } from '@angular/router';

@Component({
  selector: 'app-user-cg-view',
  templateUrl: './user-cg-view.component.html',
  styleUrls: ['./user-cg-view.component.scss']
})
export class UserCgViewComponent implements OnInit {
  ...
  add_route_link = '/dealer-code-generation/add';
  ...
  constructor(private router: Router, private itemgen: dealercodegemerateService, private commonservice: CommonService) { }
  ...
  ngOnInit() {
    ...
    this.page_main_title = this.language.userodegeneration;
  ...
  button_click1(data) {
    ...
    this.router.navigateByUrl('dealer-code-generation/edit/' + data.Code.trim());
  ...
  duplicate_record(data,isDuplicate){
    this.router.navigateByUrl('dealer-code-generation/add/' + data.Code.trim());
  }
