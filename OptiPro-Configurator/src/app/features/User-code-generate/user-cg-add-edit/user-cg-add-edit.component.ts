...
@Component({
  selector: 'app-user-cg-add-edit',
  templateUrl: './user-cg-add-edit.component.html',
  styleUrls: ['./user-cg-add-edit.component.scss']
})
export class UserCgAddEditComponent implements OnInit {
  ...
  public view_route_link = '/dealer-code-generation/view';

  constructor(
    private router: ActivatedRoute, 
    private route: Router, 
    private itemgen: dealercodegemerateService,
  ...
  companyName: string;
  page_main_title = this.language.userodegeneration;
